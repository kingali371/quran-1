    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                InlineKeyboardButton("𓂄𓆩 أَلا بِذِكرِ اللَّهِ تَطمَئِنُّ القُلوبُ 𓆪𓂁", url=f"https://t.me/S_EG_P")
                ],
                [
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    [
                    InlineKeyboardButton("𓂄𓆩أَلا بِذِكرِ اللَّهِ تَطمَئِنُّ القُلوبُ𓆪𓂁", url=f"https://t.me/S_EG_P")
                ],
                [
                InlineKeyboardButton(" ⚙️ ¦ اخفاء  ", callback_data="close_play")
                ],
